...
<?php else : ?>
    ...
    <p>Ditt konto verkar inte ha rätt behörighet för att betala här.</p>
    <p class="info">Kontakta <a href="mailto:info@loopis.app">info@loopis.app</a> om du behöver hjälp.</p>
