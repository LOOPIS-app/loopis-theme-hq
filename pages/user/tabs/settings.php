...
<p>📍 Primärt område: <b><?php include LOOPIS_THEME_DIR . '/includes/output/user-data/user-area.php'; ?></b></p>
</div>

<p><span class="big-link"><a href="<?php echo esc_url(home_url('/user/?view=member-data')); ?>">📝 Medlemsregister</a></span> för dina aktuella uppgifter</p>
