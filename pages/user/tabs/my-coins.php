<?php
/**
 * Tab showing rainbow coins of user.
 */
...
<!--Info-->
<p class="small">💡 Detaljerad lista över din aktivitet finns på fliken <span class="link"><a href="<?php echo esc_url(network_home_url('/user')); ?>">🧮 Min aktivitet</a></span></p>
