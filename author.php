...
<h1>👤 <?php include_once LOOPIS_THEME_HQ_DIR . '/templates/user/profile/user-names.php'; ?></h1>
<hr>
...
<p>Bor i <span class="label">📍 <?php include LOOPIS_THEME_HQ_DIR . '/templates/user/profile/user-area.php'; ?></span></p>
...
<!--ADMIN LOG-->
<?php if (current_user_can('manager') || current_user_can('administrator')) { include LOOPIS_THEME_HQ_DIR . '/templates/admin/profile/user-summary.php'; } ?>
